...
const MAX_LINKEDIN_TEXT_LENGTH = 50000;
const MIN_LINKEDIN_TEXT_LENGTH = 50;
const MAX_EVENT_DESCRIPTION_LENGTH = 1000;

const LINKEDIN_SECTION_HEADERS = [
  "contact",
  "top skills",
  "languages",
  "summary",
...
const LINKEDIN_UNIQUE_PATTERNS = [
  "linkedin.com/in/",
  "www.linkedin.com/in/",
  "page 1 of",
  "connections",
...
function updateThemeIcon() {
  ...
  dom.themeToggle.innerHTML = `<i data-lucide="${isDark ? "sun" : "moon"}"></i>`;
  refreshIcons();
}
